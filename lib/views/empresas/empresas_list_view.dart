...
class _EmpresasListViewState extends State<EmpresasListView> {
  void _mostrarDialogoNovaEmpresa() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          backgroundColor: const Color(0xFF1E1E1E), // Cinza Metálico
          ...
          content: TextField(
            ...
            decoration: const InputDecoration(
              ...
              enabledBorder: UnderlineInputBorder(
                borderSide: BorderSide(color: Color(0xFFD85A36)),
              ),
              focusedBorder: UnderlineInputBorder(
                borderSide: BorderSide(color: Color(0xFF39FF14)), // Verde Neon ao focar
              ),
            ),
          ),
          actions: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFD85A36), // Laranja Terracota
              ),
              onPressed: () async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Empresa>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return const Center(
              child: Text('Erro ao carregar empresas.', style: TextStyle(color: Colors.red)),
            );
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                color: const Color(0xFF1E1E1E), // Superfície Cinza Metálico
                margin: const EdgeInsets.only(bottom: 12.0),
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                child: ListTile(
                  leading: const CircleAvatar(
                    backgroundColor: Color(0xFF2A2A2A),
                    child: Icon(Icons.business, color: Color(0xFF39FF14)), // Destaque Verde Neon
                  ),
                  title: Text(
                    empresa.nome,
      ...
      floatingActionButton: FloatingActionButton(
        ...
        foregroundColor: const Color(0xFF121212), // Ícone escuro para contraste
